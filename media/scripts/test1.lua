...
function main()
    createMesh("colliseum", "bundle-osx.app/Contents/Resources/media/models/ramp_floor.3ds", "bundle-osx.app/Contents/Resources/media/models/ramp_floor.png")
    createMeshBody("colliseum")

    createSphere("sphere1", "bundle-osx.app/Contents/Resources/media/textures/wall.bmp")
    setScale("sphere1", { 0.5, 0.5, 0.5 })
    createSphereBody("sphere1", 2.5, 15.0)
    setPosition("sphere1", { x = 0, y = 20, z = 10 })

    createCube("cube1", "bundle-osx.app/Contents/Resources/media/textures/t351sml.jpg")
    setPosition("cube1", { 0, -10, 0 })
    -- createBoxBody("cube1", { 100, 0.1, 100 }, 0)

    createAnimatedMesh("ninja", "bundle-osx.app/Contents/Resources/media/models/ninja.b3d", "bundle-osx.app/Contents/Resources/media/textures/nskinbl.jpg", 0, 13, 15)
