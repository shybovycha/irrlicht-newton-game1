...
function main()
    createMesh("colliseum", "media/media/media/models/ramp_floor.3ds", "media/media/media/models/ramp_floor.png")
    createMeshBody("colliseum")

    createSphere("sphere1", "media/media/media/textures/wall.bmp")
    setScale("sphere1", { 0.5, 0.5, 0.5 })
    createSphereBody("sphere1", 2.5, 15.0)
    setPosition("sphere1", { x = 0, y = 20, z = 10 })

    createCube("cube1", "media/media/media/textures/t351sml.jpg")
    setPosition("cube1", { 0, -10, 0 })
    -- createBoxBody("cube1", { 100, 0.1, 100 }, 0)

    createAnimatedMesh("ninja", "media/media/media/models/ninja.b3d", "media/media/media/textures/nskinbl.jpg", 0, 13, 15)
